...
/*                                                          LE - /            */
/*                                                              /             */
/*   ray_22_get_walls_hit.c                           .::    .:/ .      .::   */
/*                                                 +:+:+   +:    +:  +:+:+    */
/*   By: mbos <mbos@student.le-101.fr>              +:+   +:    +:    +:+     */
/*                                                 #+#   #+    #+    #+#      */
/*   Created: 2020/01/08 20:21:58 by mbos         #+#   ##    ##    #+#       */
/*   Updated: 2020/01/08 20:22:00 by mbos        ###    #+. /#+    ###.fr     */
/*                                                         /                  */
/*                                                        /                   */
/* ************************************************************************** */
...
static void ray_get_vt_wall_hit(t_rays *r, t_mlx *mlx)
{
	...
	to_check.y = r->vt_fst_inter.x;
	while (there_is_a_wall_at(r, to_check, mlx) == False)
	{
